module state_space_dim
    use nrtype
    implicit none
    integer,parameter::first_age_sm=25, last_age_sm=98 !First and last age in the model
    integer,parameter::T=(last_age_sm-first_age_sm+1)/2, T_R=(65-first_age_sm+1)/2, T_50=(50-first_age_sm+1)/2 !T: Model periods, T_R: time at retirement, T_50: period at age 50
