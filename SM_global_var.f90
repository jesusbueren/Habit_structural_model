module state_space_dim
    ...
    integer,parameter::T=(last_age_sm-first_age_sm+1)/2, T_R=(65-first_age_sm+1)/2, T_50=(50-first_age_sm+1)/2,T_svl=(age_svl-first_age_sm+1)/2 !T: Model periods, T_R: time at retirement, T_50: period at age 50
...
module var_first_step
    ...
    implicit none
    integer::reference_cohort=4
    real(DP),parameter::a_min=0.0d0,a_max=10000.0d0
    real(DP)::r=(1.0d0+0.04d0)**2.0d0-1.0d0
    ...
    real(DP),dimension(T_R,G_h,G_educ,2)::Pi_un !Probability of being unemployed
    ...
    real(DP),dimension(G_cohorts)::born_cohort=(/10,30,50,70,90/)
end module
...
module initial_p
    ...
    real(DP)::beq_cur_ini=103.740d0 ,c_floor_ini=5.35d0,beq_mu_ini=3.82d0
