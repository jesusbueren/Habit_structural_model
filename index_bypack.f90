	...
	USE nrtype; USE nrutil, ONLY : arth,assert_eq,nrerror,swap; use state_space_dim
	IMPLICIT NONE
	REAL(DP), DIMENSION(G_nkk), INTENT(IN) :: arr
	INTEGER, DIMENSION(G_nkk), INTENT(OUT) :: index
